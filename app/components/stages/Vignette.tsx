...
const VIGNETTE_TEMPLATES: Record<BlockType, string> = {
  prestige:
    "<strong>[NAME]</strong> is the CEO of a large company. [NAME] has several years of workplace experience and has gained a considerable degree of influence over others. His leadership strategy focuses on <strong>leveraging his skills and abilities</strong> to influence others. In leadership roles, he prioritizes excellence and high-quality work from his subordinates. [NAME] <strong>generally takes input from others on how tasks should be accomplished</strong>, although he is also good at making suggestions about how to improve ideas provided by others. When [NAME]'s subordinates have good ideas, they <strong>feel comfortable bringing them up and asking to implement them</strong>, even when those ideas are contrary to [NAME]'s view of the situation. Many subordinates follow [NAME]'s advice because they <strong>want to learn from him</strong>. In sum, [NAME] adopts a leadership style focused on making <strong>skillful decisions</strong>.",
  dominance:
